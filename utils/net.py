...
# VGG16 based model for image matting
...
# DeepLabModel to create seg_img & mask_img
...
class DeepLabModel(object):
    ...
    def __init__(self, tarball_path):
        ...
        ######-----------------Constrain Graph used memory---------------------------------    
        cfg = tf.compat.v1.ConfigProto() 
        cfg.gpu_options.per_process_gpu_memory_fraction = 0.2 # 20% GPU for tensorflow 
        self.sess = tf.compat.v1.Session(graph=self.graph, config=cfg)
